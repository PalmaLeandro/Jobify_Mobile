package com.example.root.jobify.Views.RecommendedFolksPage;
 ...
 */
public class RecommendedFolksFragment extends ContentListFragment{
    @Override
    protected ContentListProvider createService() {
        return new ContentListProvider() {
            ...
            public void getContents(final Callback<ArrayList<Content>> callback) {
                new PeopleService().getRecommendedFolks(new Callback<ArrayList<Person>>() {
                    @Override
